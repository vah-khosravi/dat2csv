...
if __name__ == "__main__":
    ...
    parser.add_argument("input", metavar="ASD", help="Binary ASD file")
    parser.add_argument("output", metavar="CSV", help="Output file - wavelength and spectral data as columns")
